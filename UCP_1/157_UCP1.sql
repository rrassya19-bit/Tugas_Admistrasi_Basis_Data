...
-- 2. TABEL DOSEN (Menambahkan UNIQUE Constraint pada Email)
...
CREATE TABLE akademik.Pengajuan_Jadwal (
    ...
    CONSTRAINT CHK_Status_Jadwal CHECK (Status IN ('Menunggu', 'Disetujui', 'Ditolak')) 
);
...
-- 5. Tambah Data Pengajuan Jadwal 
...
GO
-----------salah
-- Operator: Operator TIDAK BISA menghapus record bimbingan (mencegah kehilangan data historis)
DENY DELETE ON SCHEMA::aktivitas TO Role_TA_Operator;
GO
