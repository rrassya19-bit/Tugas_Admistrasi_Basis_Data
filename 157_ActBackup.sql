...
-- =============================
INSERT INTO Akademik.Mahasiswa VALUES
('20250140005','Rini','2004-03-20','Teknologi Sipil',2025),
('20250140006','Fajar','2003-07-08','Elektro Medis',2025);
GO
...
-- =============================
BACKUP DATABASE DBKampus
TO DISK = 'D:\BackupSQL\DBKampus_Diff2.bak'
WITH DIFFERENTIAL,
INIT,
NAME = 'Differential Backup ke-2',
STATS = 10;
GO
...
-- =============================
DELETE FROM Akademik.Mahasiswa
WHERE NIM IN ('20250140005','20250140006');
GO
...
RESTORE DATABASE DBKampus
FROM DISK = 'D:\BackupSQL\DBKampus_Diff2.bak'
WITH RECOVERY,
STATS = 10;
GO
